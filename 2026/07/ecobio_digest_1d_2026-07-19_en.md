...
- **<b>Species-Specific Controls on Rhizosphere Soil Respiration in a Tropical Deciduous Forest of Bangladesh</b>**: This dataset underpins a study investigating the drivers of rhizosphere soil respiration in the tropical deciduous forests of Bangladesh, with a specific focus on how individual tree species... Source: OpenAlex Soil Microbiology & Biogeochemistry: Figshare.
- **The functional structure of foxtail millet rhizoplane microbiome and its association with yield**: ). We constructed a comprehensive non-redundant gene catalog, reconstructed 595 metagenome-assembled genomes (MAGs), and analyzed the co-occurrence networks. Our results revealed that the... Source: OpenAlex Soil Microbiology & Biogeochemistry: Microbiology Spectrum.
- **Biocontrol and growth-promoting potential of Bacillus subtilis against root-rot disease in sugar beet**:  Source: OpenAlex Soil Microbiology & Biogeochemistry: Australasian Plant Pathology.

## 农田土壤微生物

### <b>Species-Specific Controls on Rhizosphere Soil Respiration in a Tropical Deciduous Forest of Bangladesh</b>

This dataset underpins a study investigating the drivers of rhizosphere soil respiration in the tropical deciduous forests of Bangladesh, with a specific focus on how individual tree species regulate this critical carbon flux. The research was conducted in the Bhawal.

- Source: OpenAlex Soil Microbiology & Biogeochemistry: Figshare
- Link: https://doi.org/10.6084/m9.figshare.31441099.v1
...
- Source: OpenAlex Soil Microbiology & Biogeochemistry: Australasian Plant Pathology
- Link: https://doi.org/10.1007/s13313-026-01170-6
- Keyword score: 4
- Matched keywords: biocontrol, bacillus subtilis
...
- Link: https://doi.org/10.1016/j.jenvman.2026.130468
- Keyword score: 4
- Matched keywords: paddy soil, rhizosphere
...
ABSTRACT The degradation of alpine steppe on the Qinghai‐Tibet Plateau has become a critical ecological security issue. Soil fungi, as core regulators of grassland ecosystem functioning, play a pivotal role in mediating the feedback between degradation and soil ecological processes. This study targeted Stipa purpurea alpine steppe in the Qinghai Lake Basin, establishing four degradation gradients: non‐degraded, slightly degraded, moderately degraded, and severely degraded. We aimed to investigate variations in soil fungal community attributes (composition, diversity, differential taxa, co‐occurrence network complexity, keystone taxa, and functional guilds) along a degradation gradient via ITS1 region sequencing, and to evaluate their relationships with soil properties (nutrients, moisture, and pH). The results indicated that alpine steppe degradation had a limited impact on the overall composition and alpha diversity of the soil fungal community. The community was consistently dominated by the core phyla Ascomycota , Mortierellomycota , and Basidiomycota . LEfSe analysis identified 18 differential fungal taxa that varied across the degradation gradient. Saprotrophic taxa within the Sordariomycetes class were enriched in non‐degraded soils, whereas severely degraded soils were dominated by pathogenic and stress‐tolerant taxa, such as Sclerotinia and Phialophora . Changes in these differential taxa along the alpine steppe degradation gradient were significantly correlated with soil organic carbon, available phosphorus, and pH. The complexity of the soil fungal co‐occurrence network exhibited a nonlinear response, characterized by a continuous decrease from the non‐degraded to the moderately degraded stage, followed by a slight increase under severe degradation. The keystone taxa within these networks gradually shifted from carbon‐dependent saprotrophs to stress‐tolerant or pathogenic types, a change that was strongly associated with environmental filtering under conditions of soil organic carbon scarcity. Functional prediction revealed that saprotrophic fungi were the dominant functional guild across all degradation gradients, with no significant change in relative abundance. In contrast, the relative abundance of plant‐pathogenic fungi increased progressively with intensifying degradation. Random Forest modeling confirmed that the relative abundance of the plant‐pathogenic functional guild was the most sensitive indicator in response to alpine steppe degradation. This indicator showed a significant negative correlation with soil nutrients (total nitrogen, available nitrogen, soil organic carbon, etc.) and a significant positive correlation with soil pH. This study elucidates the response patterns of the soil fungal community to alpine steppe degradation and provides a theoretical foundation for the ecological restoration of degraded alpine grasslands.

- Source: OpenAlex Soil Microbiology & Biogeochemistry: Land Degradation and Development
- Link: https://doi.org/10.1002/ldr.70774
- Keyword score: 3 | LLM score: -1
- Matched keywords: soil organic carbon, soil organic
### Editorial: Green and sustainable remediation: advances in microbial technologies for legacy and emerging contaminants
...
- Link: https://doi.org/10.3389/fenvs.2026.1926964
- Keyword score: 3 | LLM score: -1
- Matched keywords: nitrification, denitrification
## Looking Forward
...
- **<b>Species-Specific Controls on Rhizosphere Soil Respiration in a Tropical Deciduous Forest of Bangladesh</b>** — [OpenAlex Soil Microbiology & Biogeochemistry: Figshare](https://doi.org/10.6084/m9.figshare.31441099.v1)
- **The functional structure of foxtail millet rhizoplane microbiome and its association with yield** — [OpenAlex Soil Microbiology & Biogeochemistry: Microbiology Spectrum](https://doi.org/10.1128/spectrum.00707-26)
- **Biocontrol and growth-promoting potential of Bacillus subtilis against root-rot disease in sugar beet** — [OpenAlex Soil Microbiology & Biogeochemistry: Australasian Plant Pathology](https://doi.org/10.1007/s13313-026-01170-6)
- **24-Epibrassinolide is associated with shifts in rhizosphere microbial assembly and arsenic speciation in rice-cultivated paddy soil.** — [Europe PMC Soil Microbiology & Biogeochemistry: J Environ Manage](https://doi.org/10.1016/j.jenvman.2026.130468)
- **Climate-Driven Harmful Algal Blooms Impair the Coastal Nitrogen Filter and Shift Denitrification Pathways toward N<sub>2</sub>O Accumulation.** — [Europe PMC Soil Microbiology & Biogeochemistry: Environ Sci Technol](https://doi.org/10.1021/acs.est.6c01472)
- **Response of Soil Fungal Communities to the Alpine Steppe Degradation Gradient** — [OpenAlex Soil Microbiology & Biogeochemistry: Land Degradation and Development](https://doi.org/10.1002/ldr.70774)
- **Editorial: Green and sustainable remediation: advances in microbial technologies for legacy and emerging contaminants** — [OpenAlex Soil Microbiology & Biogeochemistry: Frontiers in Environmental Science](https://doi.org/10.3389/fenvs.2026.1926964)
- **Combination of Genetic Variants of nifH, nifK, and nodC Genes in the Formation of a Symbiotic Cluster in the Genome of Rhizobium leguminosarum** — [OpenAlex Soil Microbiology & Biogeochemistry: Microbiology](https://doi.org/10.1134/s0026261725604440)
