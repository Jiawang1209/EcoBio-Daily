# EcoBio Daily - 2026-08-31

> 生态学与微生物学最新研究进展日报。内容由配置源抓取、主题筛选和自动摘要生成，建议发布前人工快速复核。

## Highlights

- **Effect of Arbuscular Mycorrhizal Fungi and Plant Growth-promoting Rhizobacteria on Yield, Nutrient Content and Uptake in Tomato under Vertisol Conditions**：Tomato production requires adequate nutrient availability to sustain high yield and biomass production, while efficient nutrient acquisition remains important under reduced... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Journal of Scientific Research and Reports。
- **Bio-organic fertilizer coupled with moderate deficit irrigation optimizes cotton root system architecture and enhances salt tolerance via rhizosphere amelioration in arid saline-sodic soils**：Soil salinization severely constrains cotton ( Gossypium hirsutum L.) productivity in arid irrigated regions, while prolonged shallow drip irrigation exacerbates root... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Agricultural Water Management。
- **Topographic decoupling of tree-mortality disturbances drives contrasting soil carbon fates via divergent microbial strategies**：Climate change is exacerbating tree mortality worldwide, threatening the stability of forest soil organic carbon (SOC) stocks. However, how SOC responds to tree mortality amid... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Nature Communications。
...
- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Journal of Scientific Research and Reports
- 链接：https://doi.org/10.9734/jsrr/2026/v32i94472
- 相关性评分：6 | LLM 评分：-1
- 命中关键词：microbial inoculant, plant growth-promoting, arbuscular mycorrhiza, rhizosphere
### Bio-organic fertilizer coupled with moderate deficit irrigation optimizes cotton root system architecture and enhances salt tolerance via rhizosphere amelioration in arid saline-sodic soils

Soil salinization severely constrains cotton ( Gossypium hirsutum L.) productivity in arid irrigated regions, while prolonged shallow drip irrigation exacerbates root superficialization and limits deep soil water utilization. However, the mechanistic pathways by which coupled water-organic management regulates root system architecture (RSA) plasticity and the optimal coupling parameters remain inadequately quantified. A two-year (2022–2023) field experiment was conducted in Alar, Xinjiang, China, to investigate coupling effects of three deficit irrigation regimes (W1, W2 and W3, targeting 90%, 75% and 60% of seasonal non-stressed crop evapotranspiration, ETc) and four soil amendments (CK: chemical fertilizer; T1: biochar 4.5 t ha⁻¹; T2: potassium humate 150 kg ha⁻¹; T3: bio-organic fertilizer—composted sheep manure plus wheat straw inoculated with a salt-tolerant Bacillus subtilis strain—3.0 t ha⁻¹) on cotton RSA using integrated shovelomics and minirhizotron phenotyping. Results demonstrated that the W2 ×T3 treatment was associated with optimized RSA, showing increased deep root length density (40–80 cm) by 37.5% (from 0.48 to 0.66 cm cm⁻³) and reduced fine root turnover rate by 27.9% (from 2.47 to 1.78 year⁻¹) compared to W1 ×CK. This "steep and deep" architecture coincided with 47.2% higher root hydraulic conductivity (3.21 × 10⁻⁴ vs. 2.18 × 10⁻⁴ kg s⁻¹ MPa⁻¹ m⁻²). Structural equation modeling revealed strong associations between amendment-induced rhizosphere improvements—including 34.0% reduced Na⁺/K⁺ ratio and 50.0% increased aggregate stability—and root deepening (path coefficient β = 0.54), which showed the strongest association with yield (β = 0.59). Random forest analysis corroborated that deep rooting index (31.2% relative importance), rhizosphere Na⁺/K⁺ ratio (18.7%), and root hydraulic conductivity (13.4%) were the top yield-associated variables, whereas total root biomass ranked last of the twelve predictors (1.1%). The W2 ×T3 treatment achieved 15.3% higher seed cotton yield (5847 vs. 5072 kg ha⁻¹), 33.7% higher irrigation water productivity (WP I , 1.31 vs. 0.98 kg m⁻³) and 19.6% higher crop water productivity referenced to measured actual crop evapotranspiration (WP ET , 1.10 vs. 0.92 kg m⁻³), with 13.8% water savings. This study identified W2 ×T3 (75% ETc target + 3.0 t ha⁻¹ bio-organic fertilizer) as the optimal strategy for sustainable cotton production in arid saline-sodic soils.

- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Agricultural Water Management
- 链接：https://doi.org/10.1016/j.agwat.2026.110733
- 相关性评分：5 | LLM 评分：-1
- 命中关键词：bacillus subtilis, rhizosphere, sodic soil
### Supporting data for "Co-application of biochar, microbial inoculant, and compound fertilizer in a karst Zanthoxylum bungeanum orchard: interannual soil physicochemical responses and rhizosphere bacterial community variation"

This dataset supports a two-year field study evaluating the co-application of biochar, microbial inoculant, and compound fertilizer in a karst Zanthoxylum bungeanum orchard in Guizhou, China. The dataset includes tree-level soil physicochemical measurements from 2024 and 2025 for nine co-application treatments and an unamended control, together with sample metadata, bacterial 16S rRNA gene ASV abundance and taxonomy tables, and sample-level alpha-diversity data for 30 rhizosphere samples collected in 2025. Raw 16S rRNA gene amplicon sequencing reads are available separately from the NCBI Sequence Read Archive under BioProject PRJNA1513475. Detailed treatment coding, variable definitions, units, sample identifiers, and data descriptions are provided in the README and data dictionary.

- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)
- 链接：https://doi.org/10.5281/zenodo.22151771
- 相关性评分：5 | LLM 评分：-1
...
- 链接：https://doi.org/10.1038/s41467-026-77237-1
- 相关性评分：5 | LLM 评分：-1
- 命中关键词：forest soil, tree mortality
## Looking Forward
...
- **Effect of Arbuscular Mycorrhizal Fungi and Plant Growth-promoting Rhizobacteria on Yield, Nutrient Content and Uptake in Tomato under Vertisol Conditions** — [OpenAlex Soil Microbiology & Biogeochemistry: Journal of Scientific Research and Reports](https://doi.org/10.9734/jsrr/2026/v32i94472)
- **Bio-organic fertilizer coupled with moderate deficit irrigation optimizes cotton root system architecture and enhances salt tolerance via rhizosphere amelioration in arid saline-sodic soils** — [OpenAlex Soil Microbiology & Biogeochemistry: Agricultural Water Management](https://doi.org/10.1016/j.agwat.2026.110733)
- **Topographic decoupling of tree-mortality disturbances drives contrasting soil carbon fates via divergent microbial strategies** — [OpenAlex Soil Microbiology & Biogeochemistry: Nature Communications](https://doi.org/10.1038/s41467-026-77237-1)
- **Supporting data for "Co-application of biochar, microbial inoculant, and compound fertilizer in a karst Zanthoxylum bungeanum orchard: interannual soil physicochemical responses and rhizosphere bacterial community variation"** — [OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)](https://doi.org/10.5281/zenodo.22151771)
- **Can Organic Amendments Override Environmental Filtering of Soil Microbiomes? Evidence From 20 Years Old Agricultural Field Trials in Contrasting Tropical Sites** — [OpenAlex Soil Microbiology & Biogeochemistry: Global Change Biology](https://doi.org/10.1111/gcb.71061)
- **Supporting data for "Co-application of biochar, microbial inoculant, and compound fertilizer in a karst Zanthoxylum bungeanum orchard: interannual soil physicochemical responses and rhizosphere bacterial community variation"** — [OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)](https://doi.org/10.5281/zenodo.22151770)
- **Effects of different tillage practices on rhizosphere soil microbial communities of maize in brown soil of western Liaoning** — [OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)](https://doi.org/10.5281/zenodo.22155538)
- **Effects of different tillage practices on rhizosphere soil microbial communities of maize in brown soil of western Liaoning** — [OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)](https://doi.org/10.5281/zenodo.22155537)
