...
- **Synergistic operational optimizations and microbial responses stabilize filamentous-dominated continuous-flow partial denitrification-anammox at low-temperature.**:  Source: Europe PMC Soil Microbiology & Biogeochemistry: Bioresour Technol.
- **Application of Particle Swarm Optimisation to achieve simultaneous nitrification and denitrification removal in the aerobic biological treatment process**:  Source: Europe PMC Soil Microbiology & Biogeochemistry.
- **Water Availability Modulates Leaf Functional Trait Responses of Robinia pseudoacacia L. Seedlings to Nitrogen–Phosphorus Supply**: Water availability strongly influences nutrient utilization and plant adaptive strategies, yet how nitrogen (N) and phosphorus (P) supply interact with water conditions to regulate leaf functional... Source: OpenAlex Soil Microbiology & Biogeochemistry: Agronomy.
...
- Source: Europe PMC Soil Microbiology & Biogeochemistry: Bioresour Technol
- Link: https://doi.org/10.1016/j.biortech.2026.135549
- Keyword score: 6
- Matched keywords: nitrification, denitrification, anammox
...
- Source: Europe PMC Soil Microbiology & Biogeochemistry
- Link: https://doi.org/10.21203/rs.3.rs-10406672/v1
- Keyword score: 4
...
- Link: https://doi.org/10.3390/agronomy16151479
- Keyword score: 3 | LLM score: -1
- Matched keywords: soil organic carbon, soil organic
### From efficient nitrite accumulation to complete collapse: how a microbial community and its antibiotic resistance genes in a nitrification system respond to long-term exposure to ciprofloxacin and copper

Abstract not available.

- Source: OpenAlex Soil Microbiology & Biogeochemistry: Journal of Water Process Engineering
- Link: https://doi.org/10.1016/j.jwpe.2026.110679
- Keyword score: 2
...
- **Synergistic operational optimizations and microbial responses stabilize filamentous-dominated continuous-flow partial denitrification-anammox at low-temperature.** — [Europe PMC Soil Microbiology & Biogeochemistry: Bioresour Technol](https://doi.org/10.1016/j.biortech.2026.135549)
- **Application of Particle Swarm Optimisation to achieve simultaneous nitrification and denitrification removal in the aerobic biological treatment process** — [Europe PMC Soil Microbiology & Biogeochemistry](https://doi.org/10.21203/rs.3.rs-10406672/v1)
- **Water Availability Modulates Leaf Functional Trait Responses of Robinia pseudoacacia L. Seedlings to Nitrogen–Phosphorus Supply** — [OpenAlex Soil Microbiology & Biogeochemistry: Agronomy](https://doi.org/10.3390/agronomy16151479)
- **Arbuscular mycorrhizal fungi as master engineers of plant ion homeostasis under salt stress: a review** — [OpenAlex Soil Microbiology & Biogeochemistry: Chemical and Biological Technologies in Agriculture](https://doi.org/10.1186/s40538-026-01028-5)
- **From efficient nitrite accumulation to complete collapse: how a microbial community and its antibiotic resistance genes in a nitrification system respond to long-term exposure to ciprofloxacin and copper** — [OpenAlex Soil Microbiology & Biogeochemistry: Journal of Water Process Engineering](https://doi.org/10.1016/j.jwpe.2026.110679)
- **Sexual dimorphism in root exudation mediates belowground neighbor recognition and shapes rhizosphere soil microbial assembly** — [OpenAlex Soil Microbiology & Biogeochemistry: New Phytologist](https://doi.org/10.1111/nph.71486)
- **Optimising nitrification inhibitors safe application to reduce nitrous oxide emissions in urine patches** — [Europe PMC Soil Microbiology & Biogeochemistry](https://doi.org/10.21203/rs.3.rs-10362489/v1)
- **Functional changes in the rhizosphere microbiome during rebiosis** — [Europe PMC Soil Microbiology & Biogeochemistry](https://doi.org/10.21203/rs.3.rs-9813698/v1)
