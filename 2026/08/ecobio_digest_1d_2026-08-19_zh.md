# EcoBio Daily - 2026-08-19

> 生态学与微生物学最新研究进展日报。内容由配置源抓取、主题筛选和自动摘要生成，建议发布前人工快速复核。

## Highlights

- **Microbial Transcriptional and Metabolic Shifts Mediate Rhizosphere Organic Carbon Accumulation in Alpine Grasslands Following Six Years of Continuous Nitrogen Addition**：Global nitrogen (N) deposition alters soil organic carbon (SOC) dynamics in alpine grasslands, yet rhizosphere carbon turnover mechanisms remain debated due to a lack of... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Microorganisms。
- **Elevation modulates the effects of tourism disturbance on soil fungal and bacterial communities in a cold-temperate montane forest**：Tourism activities in mountain forests can alter belowground ecological processes, yet how soil microbial communities respond to the combined effects of elevation and tourism... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Figshare。
- **Soil Carbon Fractions and Aggregation Regulate N <sub>2</sub> O Emissions and Microbial N‐Cycling Genes: A Case Study Across Tropical Paddy Soils With Contrasting Organic Matter Levels**：ABSTRACT Background : Nitrous oxide (N 2 O) is a major greenhouse gas, and its production is shaped by soil organic matter (SOM). Yet, how different SOM‐derived labile carbon... 来源：OpenAlex Soil Microbiology & Biogeochemistry: Journal of Plant Nutrition and Soil Science。
...
- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Journal of Plant Nutrition and Soil Science
- 链接：https://doi.org/10.1002/jpln.70108
- 相关性评分：6 | LLM 评分：8
- 命中关键词：soil organic matter, nitrification, denitrification, soil organic
...
- 链接：https://doi.org/10.3390/agronomy16161583
- 相关性评分：3 | LLM 评分：8
- 命中关键词：soil carbon cycling, microbial carbon use efficiency
## 农田土壤微生物

### Data and Code for Article: "A standardized protocol for reproducible microbiota inoculum preparation from bulk and rhizosphere soils: a Pisum case study" Angot et al., (2026)

Data and code supplementary to the article "A standardized protocol for reproducible microbiota inoculum preparation from bulk and rhizosphere soils: a Pisum case study" (Angot et al., 2026).

- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)
- 链接：https://doi.org/10.5281/zenodo.21457891
- 相关性评分：2 | LLM 评分：8
- 命中关键词：rhizosphere
...
- 链接：https://doi.org/10.3389/fmicb.2026.1834232
- 相关性评分：4 | LLM 评分：7
- 命中关键词：rhizosphere
### The rhizosphere nexus: Mechanistic foundations and engineering of plant-soil-microbe interactions for agricultural sustainability

Agricultural sustainability increasingly depends on optimizing the rhizosphere nexus, where plants, soil, and microorganisms interact to regulate nutrient cycling, stress resilience, and soil health. Traditional approaches favour single-strain inoculants, which frequently fail under field conditions owing to poor persistence, strong context dependency, and limited functional scope. This review critiques the limitations of reductionist inoculation paradigms and advances a shift toward engineering the rhizosphere by integrating plant traits, soil physicochemical constraints, and microbial functional diversity. We examined the fundamental tripartite interaction, emphasizing root architecture and exudation as heritable chemical blueprints that filter microbial recruitment, while soil properties serve as environmental constraints that govern microbial persistence and functional expression. Particular emphasis was placed on molecular communication networks, including cross-kingdom signalling among plants, bacteria, and fungi, and on how conventional agricultural inputs may disrupt these coordination processes. Beyond nutrient availability, we examined how microbial communities regulate the timing of macronutrient (N, P) and essential micronutrient (Fe, Mn, Zn) availability, and critically assessed the context-dependent trade-offs of arbuscular mycorrhizal fungi (AMF) under intensive management. The review further evaluates the role of the rhizosphere microbiome in enhancing resilience to abiotic stresses, such as drought, salinity, and heat, and in suppressing biotic stresses through induced systemic resistance and the development of disease-suppressive soils. Furthermore, we have highlighted emerging strategies for rhizosphere engineering, including microbiome-enabled breeding, synthetic microbial consortia, agronomic steering, and precision microbiome management. By integrating mechanistic insights with digital agriculture, metagenomics, and data-driven decision frameworks, this review reframes the farm as a dynamically regulated ecological system rather than a site for substituting chemical inputs, offering a pathway toward a more predictable and sustainable agricultural ecosystem.

- 来源：OpenAlex Soil Microbiology & Biogeochemistry: Industrial Crops and Products
- 链接：https://doi.org/10.1016/j.indcrop.2026.124090
- 相关性评分：4 | LLM 评分：7
...
- 来源：PubMed Soil Microbiology & Biogeochemistry: Environmental science & technology
- 链接：https://pubmed.ncbi.nlm.nih.gov/42611443/
- 相关性评分：2 | LLM 评分：8
- 命中关键词：forest soil
## Looking Forward
...
- **Microbial Transcriptional and Metabolic Shifts Mediate Rhizosphere Organic Carbon Accumulation in Alpine Grasslands Following Six Years of Continuous Nitrogen Addition** — [OpenAlex Soil Microbiology & Biogeochemistry: Microorganisms](https://doi.org/10.3390/microorganisms14081808)
- **Elevation modulates the effects of tourism disturbance on soil fungal and bacterial communities in a cold-temperate montane forest** — [OpenAlex Soil Microbiology & Biogeochemistry: Figshare](https://doi.org/10.6084/m9.figshare.33270990)
- **Soil Carbon Fractions and Aggregation Regulate N <sub>2</sub> O Emissions and Microbial N‐Cycling Genes: A Case Study Across Tropical Paddy Soils With Contrasting Organic Matter Levels** — [OpenAlex Soil Microbiology & Biogeochemistry: Journal of Plant Nutrition and Soil Science](https://doi.org/10.1002/jpln.70108)
- **Vegetation Restoration Alters Soil Microbial Carbon Use Efficiency via Key Soil Properties and Generalist Communities in Karst Rocky Desertification** — [OpenAlex Soil Microbiology & Biogeochemistry: Agronomy](https://doi.org/10.3390/agronomy16161583)
- **Data and Code for Article: "A standardized protocol for reproducible microbiota inoculum preparation from bulk and rhizosphere soils: a Pisum case study" Angot et al., (2026)** — [OpenAlex Soil Microbiology & Biogeochemistry: Zenodo (CERN European Organization for Nuclear Research)](https://doi.org/10.5281/zenodo.21457891)
- **Detrital Inputs Regulate Condensed Aromatic Carbon Persistence in Forest Soils** — [PubMed Soil Microbiology & Biogeochemistry: Environmental science & technology](https://pubmed.ncbi.nlm.nih.gov/42611443/)
- **Effects of different crop intercropping on quality and rhizosphere soil microbial community of Erigeron breviscapus** — [OpenAlex Soil Microbiology & Biogeochemistry: Frontiers in Microbiology](https://doi.org/10.3389/fmicb.2026.1834232)
- **The rhizosphere nexus: Mechanistic foundations and engineering of plant-soil-microbe interactions for agricultural sustainability** — [OpenAlex Soil Microbiology & Biogeochemistry: Industrial Crops and Products](https://doi.org/10.1016/j.indcrop.2026.124090)
